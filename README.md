...
You can try Giggle.js one-to-one calls there: ./examples/single_client.html
...
You can try Giggle.js multiparty calls there: ./examples/muji_client.html
...
API documentation: ./doc/ (build the project before with `grunt build`)
